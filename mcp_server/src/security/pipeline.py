...
class SecureCodePipeline:
    ...
    def run(self, code_string: str, extra_globals=None):
        """Execute code securely through the pipeline."""
        ...
        execution_result = self.executor.execute(code_string, extra_globals or {})
